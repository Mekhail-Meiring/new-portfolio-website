...
Command: npx gltfjsx@6.1.4 python-logo.gltf --transform
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('./models/python-logo-transformed.glb')
...
useGLTF.preload('./models/python-logo-transformed.glb')
