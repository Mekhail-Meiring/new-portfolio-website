...
Command: npx gltfjsx@6.1.4 java-logo.gltf --transform
...
export default function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('./models/java-logo-transformed.glb')
...
useGLTF.preload('./models/java-logo-transformed.glb')
